...
Immutable F16 RMS-normalization weights are expanded exactly to F32 once during
model loading, rather than converted on every AR step. Both direct and pipeline
...
its actual nodes and leaf references. Every input is refreshed on reuse, and
